...
const databaseUri = `${process.env.MONGODB_PROTOCOL}${process.env.MONGODB_USERNAME}:${process.env.MONGODB_PASSWORD}@${process.env.MONGODB_CLUSTER_URL}/${process.env.MONGODB_NAME}?${process.env.MONGODB_CONNECTION_OPTIONS}`;
